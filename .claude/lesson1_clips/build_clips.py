...
IDS = {
    ...
    '06': '1IcClZUW-Ns0T38wcJJ8hgdnsw0eehxCK',  # «Второе определение Рава», 2007-12-09
}
...
CLIPS = {
    '05': clip('05', '«Каббала за 20 секунд». Блогер просит объяснить, что такое каббала, и даёт минуту. Рав укладывается в двадцать секунд — короткое определение рядом с длинным.'),
    ...
    '01': clip('01', 'Рав вспоминает домашнюю библиотеку: до верхних полок он в детстве не дотягивался. «Человеку надо доставать только до того уровня, который будет его правильно воспитывать… Наука каббала ждала не своего человека, а своего поколения, в котором она может раскрыться. Мы и являемся тем поколением».'),
}
