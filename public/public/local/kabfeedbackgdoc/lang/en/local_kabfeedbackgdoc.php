...
$string['pluginname'] = 'Feedback → Google Doc (KAB)';
...
$string['webhookurl_desc'] = 'Deployment URL of the Apps Script bound to the Google Doc (https://script.google.com/macros/s/.../exec). Empty = nothing is sent.';
...
$string['cmids_desc'] = 'Comma-separated course module ids of the feedback activities to forward (the "id" in the activity URL). Empty = every feedback activity on the site.';
